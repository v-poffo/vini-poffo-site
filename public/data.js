...
const siteData = {
  site: {
    ...
    aboutCards: [
        { id: 1, title: "Vini Poffo", text: "Sou cineasta, diretora criativa e artista, com foco em cinema, videoclipes e projetos publicitários. Meu trabalho busca questionar narrativas convencionais e criar espaços para novas perspectivas através de uma abordagem artesanal. Cada projeto é atravessado por símbolos, política e afeto. Já tive trabalhos premiados no Brasil e exibidos internacionalmente, sempre mantendo a autenticidade e a profundidade como pilares do processo criativo.", color: "green", img: "assets/quem-sou-eu/mobile-card-1.png", type: "text", modal: "quemSouEuModal" },
        { id: 2, title: "Filmes", text: "Desenvolvo filmes autorais que investigam identidade, memória e território.", color: "blue", type: "modal", modal: "filmesModal", img: "assets/quem-sou-eu/mobile-card-2.jpg" },
        { id: 3, title: "Prêmios", text: "Reconhecimentos e prêmios conquistados ao longo da trajetória criativa.", color: "blue", type: "modal", modal: "premiosModal", img: "assets/quem-sou-eu/mobile-card-3.png" },
        { id: 4, title: "Processo Criativo", text: "Me interesso por imagens que carregam tempo. Cenários, objetos, corpos e luz estão ali para dizer alguma coisa. Meu processo criativo parte da imagem como sensação. A imagem precisa atravessar o corpo, criar estado e provocar alguma coisa em quem vê. Trabalho com objetos de memória — elementos que carregam vida dentro da obra.", color: "green", img: "assets/quem-sou-eu/mobile-card-4.png", type: "text", modal: "processoCriativoModal" },
        { id: 5, title: "Videoclipes", text: "Vejo o videoclipe como um espaço de invenção estética, onde imagem, corpo e som constroem narrativas experimentais e com força conceitual.", color: "blue", type: "modal", modal: "videoclipesModal", img: "assets/quem-sou-eu/mobile-card-5.png" },
        { id: 6, title: "Arte, Cenografia e Outros", text: "Experiências que ampliam meu olhar sobre o set e fortalecem minha capacidade de construir projetos.", color: "blue", type: "modal", modal: "cenografiaModal", img: "assets/quem-sou-eu/mobile-card-6.png" },
        { id: 7, title: "Projetos", text: "Explore meu portfólio completo.", color: "blue", link: "projetos.html", img: "assets/quem-sou-eu/mobile-card-7.png" },
        { id: 8, title: "Direção", text: "Acredito no cinema e no audiovisual como prática coletiva. Tenho experiência em liderar equipes, dialogar com diferentes departamentos e construir processos colaborativos, respeitando os tempos e as singularidades de cada projeto. Dirigir, pra mim, é estar presente e atenta aos detalhes, articulando para que conceito e execução caminhem juntos.", color: "green", img: "assets/quem-sou-eu/mobile-card-8.png", type: "text", modal: "direcaoModal" },
        { id: 9, title: "Cinema Autoral", text: "Cada filme ou videoclipe é resultado de referências, vivências, observação de corpos, espaços e gestos cotidianos. O cinema se constrói aos poucos, carrega marcas do processo, do tempo e das pessoas envolvidas. Gosto quando a imagem tem vida própria, quando algo nela continua vibrando depois que termina. Penso o set como um espaço vivo, onde imagem, corpo e tempo estão em constante negociação. Gosto de estar próxima do processo, acompanhando cada detalhe, porque é ali que a magia acontece.", color: "green", type: "text", img: "assets/quem-sou-eu/mobile-card-9.png", modal: "cinemaAutoralModal" },
        { id: 10, title: "Vamos Conversar?", text: "Estou aberta a colaborações e novos projetos.<br><br>Se você busca imagens com intenção, sensibilidade e presença, vamos trocar.", color: "blue", type: "contact", img: "assets/quem-sou-eu/mobile-card-9.png" }
    ],
    modals: {
        filmes: [
        ...
        cenografia: [
            { t: "Santo", y: "2025", d: "assist. de arte", a: "Curta-metragem" },
            { t: "CERAVE - Pele Sequinha", y: "2025", d: "assist. de produção de objetos", a: "Publicidade" },
            { t: "Nutren - Eu Me Vejo Pro-Idade", y: "2025", d: "assist. de produção de objetos", a: "Publicidade" },
            { t: "Voe Azul", y: "2025", d: "assist. de objetos", a: "Publicidade" },
            { t: "Album - Som do Ale", y: "2025", d: "assist. de arte e cenografia", a: "Visualizer" },
            { t: "DIVA - Calma Sao Paulo", y: "2025", d: "assist. de arte", a: "Editorial" },
            { t: "Calma Business - Calma Sao Paulo", y: "2024", d: "assist. de arte", a: "Editorial" },
            { t: "Segue o Baile - E! Channel", y: "2024", d: "making of (still) e operação de câmera PTZ", a: "Reality show" },
            { t: "Maria Homem", y: "2020 - Atualmente", d: "direção e criação de conteúdo", a: "YouTube e Instagram" },
            { t: "Parte de Mim", y: "2021", d: "direção", a: "Videoarte - FUNARTE<br>Projeto premiado no Premio RespirArte da FUNARTE" }
        ]
    }
  },
  projects: [
